// BACKUP: Original DartboardHeatmapBlur.tsx (31.01.2026)
// This is the backup of the working heatmap component before optimization
...
export const DartboardHeatmapBlurBackup: React.FC<DartboardHeatmapBlurProps> = ({
  heatmapData,
  size = 600,
  compact = false
}) => {
